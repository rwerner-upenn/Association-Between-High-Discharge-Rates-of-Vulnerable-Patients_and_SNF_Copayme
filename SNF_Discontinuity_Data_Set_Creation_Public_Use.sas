/*PLEASE CITE THIS ARTICLE AS:
 ...
 Chatterjee P, Qi M, Coe NB, Konetzka RT, Werner RM. Association Between High Discharge Rates of Vulnerable Patients and Skilled Nursing Facility Copayments. 
 JAMA Intern Med. Published online May 28, 2019. doi:10.1001/jamainternmed.2019.1209 */

/********************************************************************************************************************************************************************************
 *Goal: Determine SNF benefit days beneficiaries have used on their 1st day of current SNF stay. And create a SNF-discharge level data set with SNF benefit day variable, 
        Medicare payment variables and readmission variables of prior hospital stay.

 *Time frame: Jan 1st 2012 - Dec 1st 2015
********************************************************************************************************************************************************************************/
...
on a.bene_id=b.bene_id and a.admsndt<b.admsndt+365;
quit; *58,188,542;
...
/*****************************************************************************
 Step 7: Create readmission in SNF indicator and 30-day readmission after SNF
         discharge indicator
*****************************************************************************/
proc sql;
...
/*****************************************************************************
 Step 8: Create the final SNF analytical data set
*****************************************************************************/
...
libname state "/secure/project/PACUse_RWerner/SNF_bene_days/Dual_Eligible_Line_Graph";
...
set snf_bpt.SNF_Bene_Period_1216_s_36;
run;
...
proc export data=snf_bpa.SNF_Bene_Period_1216 
            outfile="/secure/project/PACUse_RWerner/SNF_bene_days/Analytical_Files/SNF_Bene_Period_1216.dta" dbms=dta replace; 
run;
